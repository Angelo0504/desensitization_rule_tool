package com.wz.desensitizationRuleTool.services.index;

import com.wz.desensitizationRuleTool.controller.index.SystemSettingController;
...
public class SystemSettingService {
    ...
    public static void openSystemSettings(String title) {
        ...
        FxDialog<SystemSettingController> dialog = new FxDialog<SystemSettingController>()
            .setTitle(title)
            .setBodyFxml("/com/wz/desensitizationRuleTool/fxmlView/index/SystemSetting.fxml")
